...
const CONST_WOMEN_HOME_PAGE_CAROUSEL_ITEMS: VerticalCarouselItem[] = [
  {
    id: "1",
  ...
  },
  {
    ...
    content: (
      <>
        <Image alt="Uniqlo:C" src="/branding/uniqlo-c.png" width={90} height={30} />
  ...
  },
  {
    ...
    content: (
      <>
        <Image alt="HEATTECH" src="/branding/heattech-logo.jpg" width={30} height={30} />
  ...
  },
  {
    ...
    content: (
      <>
        <Image alt="HEATTECH" src="/branding/uniqlo-ut.png" width={30} height={30} />
...
export default function Home() {
  return <VerticalCarousel items={CONST_WOMEN_HOME_PAGE_CAROUSEL_ITEMS} />;
}
